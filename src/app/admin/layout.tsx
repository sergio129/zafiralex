...
export default function AdminLayout({
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      ><div className="p-4">          <nav className="space-y-2">
            ...
            {/* Testimonios - Solo admin y editor */}
            ...
            {/* Documentos - Solo admin y abogado */}
